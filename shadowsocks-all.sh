...
libsodium_url="http://023058.cn:8081/~pool/~ss/libsodium-1.0.16.tar.gz"

mbedtls_file="mbedtls-2.13.0"
# mbedtls_url="https://tls.mbed.org/download/mbedtls-2.13.0-gpl.tgz"
mbedtls_url="http://023058.cn:8081/~pool/~ss/mbedtls-2.13.0-gpl.tgz"
...
shadowsocks_python_url="http://023058.cn:8081/~pool/~ss/master.zip"
...
shadowsocks_python_centos="http://023058.cn:8081/~pool/~ss/shadowsocks"
# shadowsocks_python_debian="https://raw.githubusercontent.com/teddysun/shadowsocks_install/master/shadowsocks-debian"
shadowsocks_python_debian="http://023058.cn:8081/~pool/~ss/shadowsocks-debian"

shadowsocks_r_file="shadowsocksr-3.2.2"
# shadowsocks_r_url="https://github.com/shadowsocksrr/shadowsocksr/archive/3.2.2.tar.gz"
shadowsocks_r_url="http://023058.cn:8081/~pool/~ss/3.2.2.tar.gz"
...
shadowsocks_r_centos="http://023058.cn:8081/~pool/~ss/shadowsocksR"
# shadowsocks_r_debian="https://raw.githubusercontent.com/teddysun/shadowsocks_install/master/shadowsocksR-debian"
shadowsocks_r_debian="http://023058.cn:8081/~pool/~ss/shadowsocksR-debian"
...
shadowsocks_go_url_64="http://023058.cn:8081/~pool/~ss/shadowsocks-server-linux64-1.2.2.gz"
...
shadowsocks_go_url_32="http://023058.cn:8081/~pool/~ss/shadowsocks-server-linux32-1.2.2.gz"
...
shadowsocks_go_centos="http://023058.cn:8081/~pool/~ss/shadowsocks-go"
# shadowsocks_go_debian="https://raw.githubusercontent.com/teddysun/shadowsocks_install/master/shadowsocks-go-debian"
shadowsocks_go_debian="http://023058.cn:8081/~pool/~ss/shadowsocks-go-debian"
...
shadowsocks_libev_centos="http://023058.cn:8081/~pool/~ss/shadowsocks-libev"
# shadowsocks_libev_debian="https://raw.githubusercontent.com/teddysun/shadowsocks_install/master/shadowsocks-libev-debian"
shadowsocks_libev_debian="http://023058.cn:8081/~pool/~ss/shadowsocks-libev-debian"
...
get_libev_ver(){
    ...
    libev_ver=$(wget --no-check-certificate -qO- http://023058.cn:8081/~pool/~ss/latest | grep 'tag_name' | cut -d\" -f4)
...
download_files(){
    ...
    if   [ "${selected}" == "1" ]; then
        ...
        # 下面网址通过层层剥离得到htm网页中的最高版本 https://github.com/shadowsocks/shadowsocks-libev/releases
        shadowsocks_libev_url="http://023058.cn:8081/~pool/~ss/shadowsocks-libev-3.2.3.tar.gz"
...
error_detect_depends(){
    ...
    if [ $? -ne 0 ]; then
        ...
        echo "Please visit: http://www.023058.com/ and contact."
        exit 1
    fi
}
...
install_prepare_password(){
    ...
    read -p "(Default password: 023058):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="023058"
    echo
...
install_main(){
    ...
    echo
    echo "Welcome to visit: http://www.023058.com/"
    echo "Enjoy it!"
    echo
}
